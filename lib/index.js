...
// Process
/* eslint-disable */
// Dynamic require is a bad practice
const postProcessPlugin = postProcess ? require(path.resolve(postProcess)) : null;
const preProcessPlugin = preProcess ? require(path.resolve(preProcess)) : null;
/* eslint-enable */
